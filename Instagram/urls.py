"""
URL configuration for Isntagram project.
...
from .views import HomeView, LoginView, RegisterView, ProfileListView, ContactView, LegalView, logout_view, ProfileDetailView, ProfileUpdateView
